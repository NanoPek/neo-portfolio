...
function Icons(props: { colors?: string[] }) {
  ...
  return (
    <div className="flex flex-row justify-evenly h-[40px]">
      <a href="https://www.linkedin.com/in/jeremiecarrez/" target="_blank" rel="noreferrer" className="hover:animate-pulse">
        <LinkedinIcon className="fill-current text-accent" style={colors ? { color: colors[0] } : {}} />
      </a>
      <a href="https://twitter.com/NanoPekTo" target="_blank" rel="noreferrer" className="hover:animate-pulse">
        <TwitterIcon className="fill-current text-accent" style={colors ? { color: colors[1] } : {}} />
      </a>
      <a href="https://github.com/NanoPek" target="_blank" rel="noreferrer" className="hover:animate-pulse">
        <GithubIcon className="fill-current text-accent" style={colors ? { color: colors[2] } : {}} />
      </a>
      <a href="https://github.com/NanoPek/neo-portfolio" target="_blank" rel="noreferrer" className="hover:animate-pulse">

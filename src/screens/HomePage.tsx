    ...
    <div className="w-full h-full flex flex-col">
      <div className="w-screen h-screen flex flex-col sm:flex-row ">
        ...
        <div className="w-full h-[55%] bg-primary pt-[10vh] sm:w-2/3 sm:h-full sm:flex sm:items-center ">
          <div className="flex flex-col bg-primary text-secondary px-12 py-6 2xl:px-32 2xl:py-32 ">
            ...
            {width >= 640 && (
              <div className="flex flex-col justify-between pt-8 pb-4 gap-4 2xl:flex-row">
        ...
        <div className="flex justify-center items-center bg-secondary h-[45%] bg-macaronis bg-center sm:pt-[10vh] sm:w-1/3 sm:h-full animate-animatedBackgroundMobile xl:animate-animatedBackground">
          <div className="h-56 w-56 bg-accent border-4 border-black z-10 bg-pp bg-cover 2xl:h-96 2xl:w-96" />
          <div className="h-56 w-56 bg-dark opacity-60 ml-6 mt-6 absolute 2xl:h-96 2xl:w-96 " />
        </div>
      </div>
      <Footer />
    </div>

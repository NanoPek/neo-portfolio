  ...
  return (
    <div className="w-full h-full flex flex-col">
      <div className="w-screen min-h-screen flex flex-col sm:flex-row ">
        ...
        <div className="flex justify-center items-center bg-secondary h-[40vh] bg-macaronis bg-center sm:pt-[10vh] sm:w-1/3 sm:h-auto animate-animatedBackgroundMobile xl:animate-animatedBackground">
